...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/19.1_Ultrasonic_Ranging/19.1_Ultrasonic_Ranging.py
    :linenos: 
    :language: python
    :lines: 11-12
    :dedent:
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/19.2_Ultrasonic_Ranging/19.2_Ultrasonic_Ranging.py
    :linenos: 
    :language: python
    :lines: 1-13
    :dedent:
